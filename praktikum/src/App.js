...
/**-------------------------------PRAKTIKUN-------------------------------- */
import React from 'react';
import Utama from './praktikum/utama';
import './App.css'
import { Link } from 'react-router-dom';
  ...
  render() {
    return(
        ...
        <nav class="navbar navbar-dark bg-primary navbar-expand-md py-md-2">
            ...
            <div class="navbar-collapse collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item py-md-2"><Link to="/" class="nav-link">Beranda</Link></li>
                    <li class="nav-item py-md-2"><Link to="/galeri" class="nav-link">Galeri</Link></li>
                    <li class="nav-item py-md-2"><Link to="/haribesar" class="nav-link">Hari Besar</Link></li>
                </ul>
            </div>
        </nav>
        <div class="cointainer-fluid">
